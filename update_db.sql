...
('huyet_khi_phun_trao', 'Huyết Khí Phun Trào <:huyet_khi_phun_trao:1525086798328369283>', 'Vật lý', 0, 9, 1, NULL, 'Đốt cháy một phần khí huyết để kích hoạt tiềm năng nhục thân, khiến cơ bắp tràn trề sức mạnh.'),
('bang_son_quyen', 'Băng Sơn Quyền <:bang_son_quyen:1525086796462162022>', 'Vật lý', 100, 0, 1, NULL, 'Dồn toàn lực vào nắm đấm, lao đến nện mạnh xuống khiến mặt đất rung chuyển, hạn chế khả năng di chuyển của địch.'),
('ba_vuong_kich', 'Bá Vương Kích 🔱', 'Vật lý', 150, 12, 10, NULL, 'Kích ra mạnh mẽ như Bá Vương xuất thế, sát thương bằng 150% Vật công.'),
('bat_hoang_toai_thach_kich', 'Bát Hoang Toái Thạch Kích <:bat_hoang_toai_thach_kich:1525024448137269421>', 'Vật lý', 150, 9, 13, NULL, 'Nhân vật vận dụng toàn bộ sức mạnh cơ bắp, gây sát thương vật lý bằng 150% Vật Công lên một mục tiêu và bỏ qua 10% Vật Phòng của đối phương. - hồi chiêu 3 hiệp'),
('cuu_long_ba_the_tran', 'Cửu Long Bá Thể Trận <:cuu_long_ba_the:1525024450687537233>', 'Vật lý', 0, 15, 13, NULL, 'Nhân vật kích hoạt khí huyết, tạo ra một lớp khiên chắn tương đương 20% HP tối đa và tăng 15% Kháng khống chế trong 3 hiệp. - hồi chiêu 5 hiệp'),
('huyet_mach_cuong_hoa', 'Huyết Mạch Cuồng Hóa <:huyet_mach_cuong_hoa:1525024458547531817>', 'Vật lý', 0, 15, 13, NULL, 'Nhân vật thiêu đốt 10% HP hiện tại để tiến vào trạng thái cuồng nộ, giúp tăng 30% Vật Công và +20 Tốc độ trong 3 hiệp. - hồi chiêu 5 hiệp'),
...
('tu_khi_thuat', 'Tụ Khí Thuật <:tu_khi_thuat:1525086802921394176>', 'Phép thuật', 0, 6, 1, NULL, 'Tu sĩ vận chuyển chu thiên, dẫn dắt linh khí đất trời vào cơ thể.'),
('linh_phao_thuat', 'Linh Pháo Thuật <:linh_phao_thuat:1525086800635494522>', 'Phép thuật', 100, 0, 1, NULL, 'Nén chân khí lại thành một viên pháo năng lượng rồi bắn thẳng vào kẻ địch.'),
('ngu_loi_thuat', 'Ngự Lôi Thuật ⚡', 'Phép thuật', 150, 12, 10, NULL, 'Dẫn lôi đình giáng xuống đầu kẻ thù, sát thương bằng 150% Pháp công.'),
('thai_hu_van_kiem_quyet', 'Thái Hư Vạn Kiếm Quyết <:thai_hu_van_kiem:1525024456840450088>', 'Phép thuật', 100, 9, 13, NULL, 'Nhân vật tiêu hao chân khí triệu hồi vô số phi kiếm, gây sát thương phép diện rộng bằng 100% Pháp Công lên toàn bộ kẻ địch và làm giảm 10% Tốc độ của chúng. - hồi chiêu 3 hiệp'),
('ngu_loi_oanh_dinh', 'Ngũ Lôi Oanh Đỉnh <:ngu_loi_oanh_dinh:1525024452830826617>', 'Phép thuật', 180, 9, 13, NULL, 'Nhân vật ngưng tụ sấm sét giáng xuống đầu một mục tiêu, gây sát thương phép cực mạnh bằng 180% Pháp Công kèm theo 20% tỷ lệ gây Tê Liệt (mất lượt hành động) trong 1 hiệp. - hồi chiêu 3 hiệp'),
('dai_tu_linh_tran', 'Đại Tụ Linh Trận <:dai_tu_linh_tran:1525024454911070258>', 'Phép thuật', 0, 15, 13, NULL, 'Nhân vật trận pháp hấp thụ linh khí đất trời, ngay lập tức hồi phục 30% Chân Khí (MP) tối đa và giảm thời gian hồi chiêu của tất cả kỹ năng khác đi 1 lượt. - hồi chiêu 5 hiệp'),
...
('tan_thu_phu_ban', 'Tân Thủ Phụ Bản ⛰️', 1, 'Luyện Khí', '{"ten":"Thiết Bì Thử (Chuột Thép)","hp":150,"vatCong":15,"phapCong":0,"vatPhong":5,"phapPhong":5}', '{"expMin":30,"expMax":50,"stonesMin":10,"stonesMax":20}', '[{"itemId":"dan_hp_1","tile":0.50},{"itemId":"dan_mp_1","tile":0.50},{"itemId":"thanh_phong_kiem","tile":0.15},{"itemId":"dao_bao_thanh_van","tile":0.15},{"itemId":"thuy_linh_boi","tile":0.15},{"itemId":"pb_lk_linh_phong_cham","tile":0.05},{"itemId":"pb_lk_dan_loi_phu","tile":0.05},{"itemId":"pb_lk_ho_than_kinh","tile":0.05},{"itemId":"pb_lk_dinh_than_phu","tile":0.05},{"itemId":"pb_lk_thanh_linh_binh","tile":0.05},{"itemId":"pb_lk_tu_khi_ky","tile":0.05},{"itemId":"thiet_cot_dao","tile":0.15},{"itemId":"tho_bo_thuc_cu","tile":0.15},{"itemId":"khuong_thach_boi","tile":0.15},{"itemId":"pb_lk_toai_thach_an","tile":0.05},{"itemId":"pb_lk_hoa_tinh_dinh","tile":0.05},{"itemId":"pb_lk_thach_phu_thuan","tile":0.05},{"itemId":"pb_lk_u_thiet_lien","tile":0.05},{"itemId":"pb_lk_da_son_sam","tile":0.05},{"itemId":"pb_lk_chien_co","tile":0.05}]'),
